...
printf "\e[1;92m                                         \e[0m\n"
printf "\e[1;92m   https://www.instagram.com/depars_07 	 \e[0m\n"
printf "\e[1;92m ___                                	 \e[0m\n"
printf "\e[1;92m| 	\  ___	__ 	 ____  ____  ____   	 \e[0m\n"
printf "\e[1;92m| 	 )|	  ||0 \ (___ |/	 __)/  __)  	 \e[0m\n"
printf "\e[1;92m| |) )|	\_|| 0_) __/ || |   \  \    	 \e[0m\n"
printf "\e[1;92m|  	 )\	|__| |  / __ ||	|   _\  \   	 \e[0m\n"
printf "\e[1;92m|__ /  \__/|_|  \____||_|  (____/      	 \e[0m\n"
printf "\n"
printf "\e[1;77m\e[45m   Instagram Brute Force v.1 Author : Depars (Github)   \e[0m\n"
printf "\n"
}
...
read -p $'\e[1;92mPassword List (Enter to default list > pass.lst): \e[0m' wl_pass
wl_pass="${wl_pass:-${default_wl_pass}}"
default_threads="10"
read -p $'\e[1;92mThreads ( Use Default > 10 ): \e[0m' threads
...
printf "\e[1;77mWaiting to Process (%s/%s)\e[0m: %s\n" $countpass $count_pass $pass
